...
var method = 'GET';
var REQUIRED_PARAMETERS = ['username'];

var CheckUsername = (function (_Base) {
    _inherits(CheckUsername, _Base);

    function CheckUsername(yo) {
        _classCallCheck(this, CheckUsername);

        _get(Object.getPrototypeOf(CheckUsername.prototype), 'constructor', this).call(this, yo);
        this.endpoint = 'check_username';
    }

    _createClass(CheckUsername, [{
        key: 'get',
        value: function get(parameters) {
            _commonValidJs2['default'].parameters(parameters, REQUIRED_PARAMETERS, true);
            return _get(Object.getPrototypeOf(CheckUsername.prototype), 'request', this).call(this, method, this.endpoint, parameters);
        }
    }]);
