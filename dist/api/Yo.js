...
var Yo = (function (_Base) {
    _inherits(Yo, _Base);

    function Yo(yo) {
        _classCallCheck(this, Yo);

        _get(Object.getPrototypeOf(Yo.prototype), 'constructor', this).call(this, yo);
        this.endpoint = 'yo';
    }
    ...
    _createClass(Yo, [{
        ...
        value: function post(parameters) {
            ...
            return _get(Object.getPrototypeOf(Yo.prototype), 'request', this).call(this, method, this.endpoint, parameters);
        }
    }]);
